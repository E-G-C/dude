...
status: defined
spec_path: .dude/specs/034-github-issue-work-intake/spec.md
---
...
- 2026-08-14 UTC - renumbered this package from `.dude/specs/033-github-issue-work-intake/` to `.dude/specs/034-github-issue-work-intake/` while merging `origin/main`, which had already landed `.dude/specs/033-conversational-brainstorm-intake/` under the same prefix; `spec_path:` now names the 034 package and earlier log events keep their original 033 wording because this log is append-only
<!-- dude:managed:end -->
