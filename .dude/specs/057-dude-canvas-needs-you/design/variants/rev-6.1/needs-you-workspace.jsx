/**
 * T008 rev-6.1 · unapproved, memory-only design artifact.
 *
...
function CommandBar({ view, viewId, hasContext, onContext, onNeeds, onNew, onRefresh, readOnly = false }) {
  const s = useStyles();
