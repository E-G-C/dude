...
7. **Send and seal were exercised by the independent verification, not by this proof.** The proof
   ...
   `design/variants/2026-09-15-t001-initial-real-engine-proof/`. Re-running the same verification
   script on the current revision reproduced the sealed set and the same awaiting-acknowledgment
   answer (`evidence/independent-t001-2026-09-15T22-19-04-134Z.json`); that re-run is the design
   author's, so it carries no independent attribution.
