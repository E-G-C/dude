...
| Governance capacity | Keep one optional target-bound governance case and one optional pending completion. | A second simultaneous target fails closed without overwriting evidence. |
