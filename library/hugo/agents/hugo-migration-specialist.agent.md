...
- Prefer bundled reference files for version-sensitive behavior, especially `.github/skills/hugo-template-authoring/references/template-checklist.md` and `.github/skills/hugo-migration/references/upgrade-and-import.md`.
