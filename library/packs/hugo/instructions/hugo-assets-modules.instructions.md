...
- For full Hugo Pipes pipelines (Sass, PostCSS/Tailwind, `js.Build`, fingerprint, minify, images, remote resources, `resources.PostProcess`), use the `dude-pack-hugo-asset-pipeline` skill.
