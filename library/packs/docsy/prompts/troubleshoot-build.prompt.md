...
- Shortcode name or parameter not recognized? Cross-check the [authoritative list](../skills/dude-pack-docsy-theme/SKILL.md#5-shortcodes--complete-set).
...
Once you've isolated the failure, point the user at the relevant section of [skill §19](../skills/dude-pack-docsy-theme/SKILL.md#19-gotchas--check-these-first-when-something-breaks) or the matching configuration/deployment section in the skill.
