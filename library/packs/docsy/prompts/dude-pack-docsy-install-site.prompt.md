...
Help the user create a new Docsy site from scratch. Reference [skill §1](../skills/dude-pack-docsy-theme/SKILL.md#1-install-4-paths).
...
## 5. Next steps
Point the user to:
- the site config section of [skill §4](../skills/dude-pack-docsy-theme/SKILL.md#4-site-config-hugotoml--hugoyaml--key-blocks) to set `baseURL`, title, and repository links.
