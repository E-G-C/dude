...
assets are in this folder (`.github/skills/dude-local-ms-visual-brand/`); the
...
| [`.github/agents/dude-local-ms-brand-stylist.agent.md`](../../agents/dude-local-ms-brand-stylist.agent.md) | The `MS Brand Stylist` custom agent                                   |
...
<link
  rel="stylesheet"
  href=".github/skills/dude-local-ms-visual-brand/tokens/ms-brand.css"
/>
