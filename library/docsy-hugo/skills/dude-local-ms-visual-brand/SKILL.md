---
name: dude-local-ms-visual-brand
description:
...
5. **Run the smoke check** from this skill when the artifact touches Hugo
   ...
   `pwsh .github/skills/dude-local-ms-visual-brand/scripts/brand-check.ps1` or
   `bash .github/skills/dude-local-ms-visual-brand/scripts/brand-check.sh`.
6. **Run the audit** in
