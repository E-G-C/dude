---
name: dude-local-hugo-docs-reference
...
4. For specific topics, open the focused reference:
   ...
   - Template functions and object methods: use the `dude-local-hugo-functions-and-methods` skill.
   - Asset processing / Hugo Pipes: use the `dude-local-hugo-asset-pipeline` skill.
