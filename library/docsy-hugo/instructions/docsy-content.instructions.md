...
- Use only [Docsy-recognized keys](../skills/dude-local-docsy/SKILL.md#3-content-structure). Don't invent keys hoping they'll be picked up.
...
- Only use shortcodes documented in the [skill reference](../skills/dude-local-docsy/SKILL.md#5-shortcodes--complete-set). Don't fabricate parameters.
