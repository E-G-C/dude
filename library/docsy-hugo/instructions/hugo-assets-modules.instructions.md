...
- For full Hugo Pipes pipelines (Sass, PostCSS/Tailwind, `js.Build`, fingerprint, minify, images, remote resources, `resources.PostProcess`), use the `dude-local-hugo-asset-pipeline` skill.
