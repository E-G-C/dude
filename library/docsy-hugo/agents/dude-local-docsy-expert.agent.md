...
| "Update / upgrade Docsy" | Use the update guidance in [.github/skills/dude-local-docsy/SKILL.md](../skills/dude-local-docsy/SKILL.md). |
| "Switch from submodule to module" | Use the conversion steps in [.github/skills/dude-local-docsy/SKILL.md](../skills/dude-local-docsy/SKILL.md). |
