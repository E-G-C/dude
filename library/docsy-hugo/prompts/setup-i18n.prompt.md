...
Help the user set up multiple languages. Reference [skill §12](../skills/dude-local-docsy/SKILL.md#12-i18n).
...
Point the user at [skill §12](../skills/dude-local-docsy/SKILL.md#12-i18n) for the full portable guide.
