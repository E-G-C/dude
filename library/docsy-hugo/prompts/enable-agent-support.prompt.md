...
Help the user expose machine-readable content for AI agents. This is **experimental**. Reference [skill §18](../skills/dude-local-docsy/SKILL.md#18-ai-agent-support-experimental).
