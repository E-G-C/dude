...
Help the user restyle a Docsy site. Reference [skill §9](../skills/docsy/SKILL.md#9-look--feel--scss) and the [SCSS rules](../instructions/docsy-scss.instructions.md).
